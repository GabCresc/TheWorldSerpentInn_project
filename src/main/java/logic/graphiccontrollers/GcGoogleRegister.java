...
public class GcGoogleRegister {
    ...
    private static final Logger logger = Logger.getLogger(GcGoogleRegister.class.getName());

    private LoginGoogleControl googleControl = new LoginGoogleControl();
